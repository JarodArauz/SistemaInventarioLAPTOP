...
namespace SistemaInventario.Areas.Admin.Controllers
{
    ...
    public class ProductoController : Controller
    {
            ...
            if (ModelState.IsValid)
            {
                ...
                else
                {
                    ...
                    if(files.Count > 0) // si se carga una nueva imagen para el producto existente
                    {
                        ...
                        productoVM.Producto.ImagenUrl = fileName + extencion;
        ...
        public async Task<IActionResult> Delete (int id)
        {
            ...
            await _unidadTrabajo.Guardar();
            return Json(new { success = true, message = "Producto borrado existosamente" });
        }
        ...
        public async Task<IActionResult> ValidarSerie(string serie,int id=0)
        {
            ...
            {
                valor = lista.Any(b => b.NumeroSerie.ToLower().Trim() == serie.ToLower() && b.Id != id);
            }
            if (valor)
            {
